...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize the enhanced signup functionality
...
// ===== REVAMPED SIGNUP FUNCTIONALITY =====

// Optimized form validation and handling
function initializeSignupForm() {
    ...
    // Form submission handler - replacing the old handler
    form.addEventListener('submit', handleOptimizedSignup);
}
...
function handleOptimizedSignup(e) {
    e.preventDefault();
...
function simulateSignupRequest(userData) {
    setTimeout(() => {
        try {
            ...
            // Show success
            const feedbackContainer = document.querySelector('#signup-form .form-feedback');
            ...
            // Close signup modal after success message is shown
            setTimeout(() => {
...
// Replace the existing handleSignup function with the optimized version
function handleSignup(e) {
    // This is kept for compatibility, but now we're using the optimized version
    handleOptimizedSignup(e);
}
